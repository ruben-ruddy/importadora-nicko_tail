...
// Si también necesitaras un DTO para crear la entrada DMS (aunque en este caso no lo usarás directamente para el body de upload, ya que es multipart/form-data)
...
//   @ApiProperty({ description: 'ID del usuario que subió el archivo (opcional)', required: false })
//   @IsOptional()
//   @IsUUID()
//   user?: string;

//   @ApiProperty({ description: 'Módulo asociado al archivo (ej. products, users) (opcional)', required: false })
//   @IsOptional()
//   @IsString()
//   module?: string;

//   @ApiProperty({ description: 'Tamaño del archivo en bytes (opcional)', required: false })
//   @IsOptional()
//   @IsInt()
//   @Type(() => Number)
//   size?: number;
