...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        primary: { 50: "#E5F1FF", 100: "#C7E1FF", 200: "#9ECBFF", 300: "#75B5FF", 400: "#4D9FFF", 500: "#2489FF", 600: "#0073FA", 700: "#0055B8", 800: "#00428F", 900: "#002F66", 950: "#001C3D" },
        secondary: { 50: "#FFF3E5", 100: "#FFE5C7", 200: "#FFD29E", 300: "#FFBF75", 400: "#FFAD4D", 500: "#FF9A24", 600: "#FA8600", 700: "#D17100", 800: "#A85B00", 900: "#804500", 950: "#472700" },
        ...
        'dark-blue-bg': '#0A192F', // Asegúrate de que este sea el valor final que quieres
        'medium-blue-bg': '#102A43',
        'light-blue-bg': '#334E68',
        'purple-start': '#667eea',
        'purple-end': '#764ba2',
        'pink-end': '#EE99C2', // Usaremos este como tu pink-end final
        'fuchsia-end': '#f093fb',
        'gray-text-dark': '#333',
      ...
      spacing: {
        '15': '3.75rem', '20': '5rem', '30': '7.5rem', '40': '10rem', '50': '12.5rem',
        '60': '15rem', '80': '20rem', '100': '25rem', '150': '37.5rem', '200': '50rem',
      },
      screens: {
        'md': '769px', // Tu $mobile-breakpoint + 1px
        'xl': '1201px', // Tu $tablet-breakpoint + 1px
      },
      gridTemplateColumns: {
      ...
      keyframes: {
        ...
        "flip-back": { "0%": { transform: "rotateY(180deg)" }, "100%": { transform: "rotateY(0deg)" } },
      ...
      boxShadow: {
        ...
        // Añadimos una sombra para el active-link si quieres que sea parte de Tailwind
        'active-link-shadow': '0 4px 10px rgba(0, 0, 0, 0.2)',
      },
      backgroundImage: {
        'services-title-gradient': 'linear-gradient(to right, var(--tw-gradient-stops))', // Usaremos un gradiente dinámico aquí
      },
    },
  },
  plugins: [
    // Este plugin permite aplicar gradientes de texto directamente con clases de utilidad
    //require('tailwindcss-text-gradient'),
    // Plugin para añadir clases de utilidad para los estilos que antes estaban en SCSS
    function({ addUtilities, theme }) {
      addUtilities({
        ...
        '.services-title-gradient-text': {
          'background-image': 'linear-gradient(to right, ' + theme('colors.purple.500') + ', ' + theme('colors.pink.500') + ')', // Puedes ajustar estos colores
          '-webkit-background-clip': 'text',
          '-webkit-text-fill-color': 'transparent',
          'background-clip': 'text',
          'color': 'transparent',
      ...
      }, ['responsive', 'hover', 'active']); // Asegúrate de que las utilidades sean responsivas y para estados
    }
  ],
};